...
def plot_comprehensive_results(results):
    ...
    axes[0, 0].set_title('Senaryo Karşılaştırması')
    ...
    axes[0, 1].set_title('Enerji-Entropi Korelasyonu')
    ...
    axes[1, 1].set_title('Yaşam-Benzeri Organizasyon Skoru')
    axes[1, 1].set_xticks(range(len(scenarios)))
    axes[1, 1].set_xticklabels([s[:15] + '...' for s in scenarios], rotation=45)
    axes[1, 1].grid(True, alpha=0.3)

    plt.tight_layout()
    plt.savefig('realistic_sqp_analysis.png', dpi=200, bbox_inches='tight')
    plt.show()
...
def run_detailed_single_simulation():
    ...
    print("\n" + "=" * 60)
    print("🔍 TEK SENARYO DETAYLI ANALİZ")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    print("🚀 SQP Gerçekçi Test Başlatılıyor...")
    ...
    if all_results:
        ...
        print("\n✅ GERÇEKÇİ TEST TAMAMLANDI!")
        print("📁 'realistic_sqp_analysis.png' kaydedildi")
    else:
